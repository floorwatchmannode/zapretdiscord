...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/floorwatchmannode/">floorwatchmannode</a><a href="https://github.com/floorwatchmannode/zapretdiscord">/zapretdiscord</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />
...
> Если вы наткнулись на что-то вне репозитория `floorwatchmannode/zapretdiscord`, что распространяется от моего лица - **ФЕЙК**.
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/floorwatchmannode/zapretdiscord/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/floorwatchmannode/zapretdiscord/issues/522)
...
- См. [#765](https://github.com/floorwatchmannode/zapretdiscord/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/floorwatchmannode/zapretdiscord/releases/latest) (`zapret-discord-youtube-...`)
...
- См. также [#251](https://github.com/floorwatchmannode/zapretdiscord/discussions/251)
...
- См. также [#252](https://github.com/floorwatchmannode/zapretdiscord/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/floorwatchmannode/zapretdiscord/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/floorwatchmannode/zapretdiscord/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/floorwatchmannode/zapretdiscord/blob/main/LICENSE.txt)

## 🩷Благодарность участникам проекта

](https://github.com/floorwatchmannode/zapretdiscord/graphs/contributors)
